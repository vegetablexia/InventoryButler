...
import com.example.inventoryshortcuts.network.MessagePayload;
import com.example.inventoryshortcuts.network.PinPayload;
import com.example.inventoryshortcuts.network.PinSyncPayload;
import com.example.inventoryshortcuts.network.SortPayload;
import com.example.inventoryshortcuts.network.TrashPayload;
import com.example.inventoryshortcuts.network.TrashSyncPayload;
import com.example.inventoryshortcuts.server.FavoriteHandler;
import com.example.inventoryshortcuts.server.InventorySortHandler;
import com.example.inventoryshortcuts.server.PlacementHandler;
import com.example.inventoryshortcuts.server.TrashHandler;
